    ...
    <form method="POST" action="{{ route('demandas.update', [$demanda->id]) }}">
        ...
        <div class="mb-3">
                ...
                <div class="form-group">
                    <textarea type="text" rows="7" id="descricao" name="descricao" class=" resize border rounded-md w-full {{ $errors->has('descricao') ? ' is-invalid' : '' }}" required>{{old('descricao', $demanda->descricao) ?? ''}}</textarea>
                </div>
