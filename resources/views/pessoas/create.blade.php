    ...
    <form method="POST" action="{{ route("pessoas.store") }}">
        ...
        <div class="body">
            ...
            <div class="mb-3">
                ...
                <div class="form-group">
                    <input type="data_associacao" id="data_associacao"  name="data_associacao" class="date {{ $errors->has('data_associacao') ? ' is-invalid' : '' }}" value="{{ old('data_associacao') }}" autocomplete="off">
                </div>
